...
<% 
 ...
 List<Food> foodList = (List)session.getAttribute("sessFoodList");
  ...
  int[] qty1 = new int[100];
                 qty1= (int[])session.getAttribute("sessCartQty");  

String dated= (String)session.getAttribute("sessDate");
String selectedTime = (String)session.getAttribute("sessSelectTime");
      ...
      <div class="container">
          <div class="cart_inner">
              <div class="table-responsive">
                  ...
                  <h5 style="margin-left:25px; margin-top: 0px; font-size: 32px"><b>Pre-order Cart</b></h5>
                  <br/>
                  <h5 style="margin-left:25px;">Order Date :&nbsp;&nbsp;<span style="color: red ;"><%= dated%></span></h5>
                        <br/>
                  <h5 style="margin-left:25px;">Order Time :<span style="color: red ;"><%=selectedTime %></span></h5>
                      <br/>
                  <table class="table">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  <h5>RM<%=String.format("%.2f", fOrderList.get(i).getFoodprice()*qty1[i]) %></h5>
                              </td>
                              
                          </tr>
                               <%   
                                   total+=fOrderList.get(i).getFoodprice() *qty1[i];
                          ...
                          <tr class="out_button_area">
                              ...
                              <td>
                                  <div class="checkout_btn_inner d-flex align-items-center">
                                        ...
                                        <a class="gray_btn" href="cart.jsp"  style=" width: 120px; height: 40px;" >Back</a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      
                                      
                                      <a class="button" href="../AddOrder"  style=" padding: 10px; width: 120px; height: 45px" onclick="return confirm('Are you sure you want to purchase?')" >&nbsp;&nbsp;&nbsp;&nbsp;Purchase</a>
