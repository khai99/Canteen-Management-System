...
<body>
                  ...
                  <table class="table">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                 <h5><%=orderList.get(i).getOrdertime()%></h5>
                              </td>
                               <td>
                                   <h5>RM<%= String.format("%.2f",orderList.get(i).getTotalamount())%></h5>
                              </td>
                              <td>
                                 <%  int totalCalories=0;
                                ...
                                if(foodList.get(k).getFoodid().equals(detailList.get(j).getOrderdetailPK().getFoodid())) {%>
                                 ...
                                 <%  int total=foodList.get(k).getFoodcalories()*detailList.get(j).getQuantity();
                                     totalCalories +=total;}}}}%>
                              </td>
                              <td>
                                  <h5><%= totalCalories%>cals</h5>
                              ...
                              <td>
                                  ...
                                  <form action="../deleteOrder">
                                      <input name="orderdel" type="hidden" value="<%=orderList.get(i).getOrderid() %>">
  ...
  <!--       Complete-->
    ...
    <section class="cart_area">
      <div class="container">
          <div class="cart_inner">
              <h2 style="font-size: 28px; margin-left: 20px;">Redeemed / Completed order</h2>
              <div class="table-responsive">
                  <table class="table">
                      <thead>
                          <tr>
