...
<% 
 ...
 List<Food> foodList = (List)session.getAttribute("sessFoodList");
  ...
  int[] qty1 = new int[100];
                 qty1= (int[])session.getAttribute("sessCartQty2");  
                          ...
                          <tr class="out_button_area">
                              ...
                              <td>
                                  <div class="checkout_btn_inner d-flex align-items-center">
                                        ...
                                        <a class="gray_btn" href="ordercart.jsp"  style=" width: 120px; height: 40px;" >Back</a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      
                                      
                                      <a class="button" href="../AddOrderNow"  style=" padding: 10px; width: 120px; height: 45px" onclick="return confirm('Are you sure you want to purchase?')" >&nbsp;&nbsp;&nbsp;&nbsp;Purchase</a>
