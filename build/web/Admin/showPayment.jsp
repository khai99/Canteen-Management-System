<%-- 
    ...
    Created on : Apr 11, 2019, 5:28:22 PM
    Author     : vinso
--%>
...
List<Customer> newCustList = (List)session.getAttribute("newCustList");
//String custID = (String)session.getAttribute("sessCustID");

String newCust = (String)session.getAttribute("custID");
Double iniTopup = Double.parseDouble(session.getAttribute("topUpAmount").toString());
Double credPoint = 0.0;
String custName = "";
String latestCustID = "";
for(int i = 0; i < newCustList.size(); i++){
if(newCustList.get(i).getCustid().equals(newCust)){
   credPoint = newCustList.get(i).getCreditpoint();
   custName = newCustList.get(i).getCustname();
   latestCustID = newCustList.get(i).getCustid();
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Successful Topup Record</a></li>
                                                       </ul>
                                                ...
                                                <form id="add-department" method="POST" action="../confirmPayment" class="add-department">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <h4>Customer Name</h4>
                                                            <input name="custName" readonly="readonly" type="text" value="<%=custName %>" class="form-control6" placeholder="Staff Name" disabled="disabled">
                                                            </div>
                                                            
                                                            <div class="form-group">  
                                                            <h4>Customer ID</h4>

                                                            <input name="custID"  type="text" value="<%=newCust %>" readonly="readonly"  class="form-control7"  placeholder="Customer ID">
                                                            </div>
                                                            <div class="form-group">
                                                                <h4 style="color: red">Amount Topup (RM)</h4>
                                                             <input name="custID"  type="text" value="<%=String.format("%.2f",iniTopup) %>" readonly="readonly"  class="form-control7"  placeholder="Customer ID">
                                                        ...
                                                        <div class="col-md-6  col-sm-6 col-xs-12">
                                                            ...
                                                            <input name="date" value="<%=strDate %>" type="text" class="form-control9" placeholder="Date" readonly="readonly">
                                                            </div>
                                                             <div class="form-group"> 
                                                                 <h4 style="color:red">Updated Total Amount (RM)</h4>

                                                            <input name="existingAmount" value="<%=String.format("%.2f", credPoint) %>"  disabled="disabled" step=".01"  maxlength="5" type="number" class="form-control8" placeholder="Amount">
                                                            </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                      ...
                                                      <br>
                                                            ...
                                                            <a class="btn btn-primary waves-effect waves-light" href="searchCusTopup.jsp">Done</a>
