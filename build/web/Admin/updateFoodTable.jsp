<%-- 
    Document   : updateFoodTable
    Created on : Mar 28, 2019, 10:39:40 PM
    Author     : vinso
--%>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Update <span class="table-project-n">Existing</span> Food</h1>
                                </div>
                            </div>
                            <br>
                            <br>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <form action="../processUpdateFood" method="POST">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id">Food ID</th>
                                                <th data-field="name" >Food Name</th>
                                                <th data-field="email">Food Price (RM)</th>
                                                <th data-field="phone" >Food Desc</th>
                                                <th data-field="complete">Food Calories</th>
                                                <th data-field="task" >Food Status</th>
                                                <th data-field="new">Food Type</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=foodList.get(i).getFoodid() %></td>
                                                <td><%=foodList.get(i).getFoodname() %></td>
                                                <td><%=String.format("%.2f", foodList.get(i).getFoodprice())%></td>
                                                <td><%=foodList.get(i).getFooddesc() %></td>
                                                                                                
                                                <td><%=foodList.get(i).getFoodcalories() %>&nbsp;cal</td>
                                                <td><%=foodList.get(i).getFoodstatus() %></td>
                                                <td><%=foodList.get(i).getFoodtype()  %></td>
