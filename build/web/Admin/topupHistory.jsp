<%-- 
    ...
    Created on : Mar 29, 2019, 8:57:11 PM
    Author     : vinso
--%>
...
<%
   List<Topuppayment> topupList = (List)session.getAttribute("sessTopupList");
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Topup <span class="table-project-n">Payment</span> History</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id">Payment ID</th>
                                                <th data-field="name" >Amount(RM)</th>
                                                <th data-field="email" >Date</th>
                                                <th data-field="phone" >Customer ID</th>
                               ...
                               for(int i = 0; i < topupList.size();i++){ 
                                            ...
                                            <tr>
                                                ...
                                                <td><%=String.format("%.2f",topupList.get(i).getTopupamount()) %></td>
                                                <td><%=dateFormat.format(topupList.get(i).getTopupdate()) %></td>
                                                <td><%=topupList.get(i).getCustid().getCustid() %></td>
