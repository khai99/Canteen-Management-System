<%-- 
    Document   : custOrderReport
    Created on : Apr 12, 2019, 9:18:10 PM
    Author     : vinso
--%>
...
<html>
    ...
    <body>
        <%
            ...
            File file = new File(application.getRealPath("//Report//dailyOrderReport.jasper"));
            java.util.Map parameter = new HashMap();
            parameter.put("parameter1", start);
            parameter.put("parameter2",st);
            parameter.put("parameter3",dater);
