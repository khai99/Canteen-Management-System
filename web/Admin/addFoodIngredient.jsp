<%-- 
    Document   : addFoodIngredient
    Created on : Mar 26, 2019, 9:53:33 PM
    Author     : vinso
--%>
...
<body>
  <!--[if lt IE 8]>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Add New Food</a></li>
                                <li><a href="#reviews"> Add New Ingredient</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <form  method="POST" action="../addFood" class="" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <input name="foodName" required pattern="([A-z\s]){2,}"  type="text" class="form-control" required="required" maxlength="30" style="border-color:gray" placeholder="Food Name">
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Food Price</h4>
                                                                    <input name="foodPrice" type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required="required" min="1" step=".01" max="100" maxlength="5" class="form-control1" style="border-color:gray" placeholder="Food Price">
                                                                    
                                                                </div>
                                                                <div class="form-group">
                                                                <h4>Food Calories</h4>

                                                                <input name="foodCalories" type="number" required="required" min="1" step="any" max="5000" maxlength="4" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control1" style="border-color:gray" placeholder="Food Calories">
                                                                </div>
                                                                <div class="form-group ">
                                                                        <div class="input-group">
                                                                    <h4>Food Image</h4>
                                                    <input  style="color: black" type="file" name="foodImg" accept=".jpg,.jpeg,.png"  required="required"><br><br>
                                </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                    ...
                                                                    <textarea name="description" style="border: 1px solid #000;border-color:gray;" required="required" maxlength="300" placeholder="Food Description"></textarea>
                                                                </div>
                                                                <div class="form-group">
                                                                <h4>Food Status</h4>
                                                                <select name="foodStatus" required="required" class="form-control" style="border-color:gray">
   ...
   <div class="form-group">
                                                                <h4>Food Type</h4>
                                                                <select name="foodType" required="required" class="form-control" style="border-color:gray">
                                  ...
                                  <table id="customers" >
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input style="width: 65%;" type="number" min="1"  required="required"  value="10" maxlength="4" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="<%=ingreList.get(i).getIngredientid()%>"/></td>

                                                   <td><input type="checkbox" name="ingredientSelect" value="<%=ingreList.get(i).getIngredientid()%>"  value="ON" /> </td>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Add Food</button>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="devit-card-custom">
                                                                                                                       ...
                                                                                                                       <div class="form-group">
                                                                                                                        ...
                                                                                                                        <input type="text" name="ingredientName" required="required" required pattern="([A-z\s]){2,}" maxlength="30" class="form-control1" placeholder="Ingredient Name" style="border-color:gray">
                                                            </div>
                                                                                                                                                        ...
                                                                                                                                                        <br>
                                                                                                                                                         <button type="submit" class="btn btn-primary waves-effect waves-light">Add Ingredient</button>
