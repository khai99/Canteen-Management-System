<%-- 
    Document   : searchCusTopup
    Created on : Apr 2, 2019, 9:02:23 PM
    Author     : vinso
--%>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form id="add-department" method="POST" action="../searchTopup" class="add-department">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                            <h4>Staff Name</h4>
                                                            <input name="staffName" type="text" value="<%=staff.getStaffname() %>" class="form-control6" placeholder="Staff Name" disabled="disabled" style="background-color:#ECECE9">
                                                            </div>
                                                            <div class="form-group">
                                                            <h4>Customer ID</h4>

                                                                <input name="custID" maxlength="6" required="required" type="text" class="form-control7" placeholder="Customer ID">
                                                            </div>
