<%-- 
    Document   : validCouponDetail
    Created on : Apr 6, 2019, 3:03:19 PM
    Author     : vinso
--%>
...
<!DOCTYPE html>
<%-- 
    Document   : couponValidity
    Created on : Apr 6, 2019, 1:40:28 PM
    Author     : vinso
--%>
...
List<Orderdetail> orderList =(List)session.getAttribute("sessOrderDetail1");
...
for(int i = 0; i < orderList.size(); i++){
 if(orderList.get(i).getOrderdetailPK().getOrderid().equals(cOrderID)){  
   newID = orderList.get(i).getOrderdetailPK().getOrderid();
   type = orderList.get(i).getOrders().getOrdertype();
   date2 = orderList.get(i).getOrders().getOrderdate();
   //orderTime = orderList.get(i).getOrders().getOrdertime();
   status = orderList.get(i).getOrders().getOrderstatus();
   orderTime = orderList.get(i).getOrders().getOrdertime();
   hiddenID = orderList.get(i).getOrderdetailPK().getOrderid();
 }
}
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Coupon Validity</a></li>
                                                       </ul>
                                                ...
                                                <form method="POST" action="../searchOrderID">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <input name="name" value="<%=staff.getStaffname() %>" type="text" class="form-control6" placeholder="Staff Name" disabled="disabled" style="background-color:#ECE9E9">
                                                            </div>
                                                            <div class="form-group">
                                                            <label>Order ID</label>

                                                                <input name="orderID" maxlength="6" type="text" class="form-control1" placeholder="Order ID">
                                                            </div>
                                                        ...
                                                        <div class="col-md-6  col-sm-6 col-xs-12">
                                                            ...
                                                            <input name="date" type="text" value="<%=strDate %>" class="form-control9" placeholder="Date" disabled="disabled" style="background-color:#ECE9E9">
                                                            </div>
                                                                     </div>                                           
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1> Order<span class="table-project-n"></span> Record</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <form method="POST" action="../redeemCoupon">
                                    <table id="table" data-toggle="table" data-pagination="true"  data-key-events="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                 <input type="hidden" name="carryForward" value="<%=hiddenID %>" >
                                                 <th data-field="id">Order ID</th>
                                                 <td><%=newID %></td>
                                            </tr>
                                             <tr>
                                                
                                                 <th data-field="id">Order Status</th>
                                                 <td><%=status %></td>
                                            </tr>
                                            <tr>
                                               
                                                 <th data-field="food">Food Name and Order Quantity</th>
                                                 
                                                 <td>
                                                     <%  String carryOutID = "";
                                                         for(int i = 0; i < orderList.size(); i++){  
                                                         if(cOrderID.equals(orderList.get(i).getOrderdetailPK().getOrderid())){ 
                                                          carryOutID = orderList.get(i).getOrderdetailPK().getOrderid();
                                                         
                                                  %>     
                                                 
                                                     <%=orderList.get(i).getFood().getFoodname() %> X <%=orderList.get(i).getQuantity() %> <br/>
                                                 <% } %>
                                                 <% } %>
                                            ...
                                            <tr>
                                                 ...
                                                 <td><%=orderTime %></td>
                                                     ...
                                                     <br/><br/>
                                                        ...
                                                        <div>
                                                            <button type="submit" class="btn btn-primary waves-effect waves-light">Redeem</button>
