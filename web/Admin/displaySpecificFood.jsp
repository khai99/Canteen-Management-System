            ...
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item submenu dropdown">
               ...
               <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
                   ...
                   <li style=" font-family:  sans-serif; margin-top: 40px; "><b>Chiam Swin Qi &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></li> 
	...
	<div class="product_image_area">
		<div class="container">
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div>
                                            <img src="img/<%=foodImg %>" style="margin-left:120px;margin-top:50px ;width:350px;height:350px;" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1a">
					<div class="s_product_text">
						...
						<div class="product_count">
             							<a class="button primary-btn" href="#">Pre order</a> 
