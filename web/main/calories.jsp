	...
	<section class="blog-banner-area" id="category">
		<div class="container h-100">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Total Calories</li>
            </ol>
          </nav>
				</div>
			</div>
  ...
  <section class="cart_area">
      <div class="container">
          <div class="shipping_box">
                                      ...
                                      <input style="font-size: 16px; font-family: 'Material-Design-Iconic-Font'; " type="date" value="" name="date"  />
                                      
                                  
                                  </div>
          <h1 style="margin :auto; font-size: 30px;">Current Credit Point  :<span class="counter" style="color: red;"> <%=sessCustomer.getCreditpoint()%></span></h1><br/><br/>
