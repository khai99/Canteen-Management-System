                      ...
                      <tbody>
                          ...
                          <tr>
                                <td>
                                  ...
                                  <a  href="../remove?id=<%=fOrderList.get(i).getFoodID() %>" onclick="return confirm('Are you sure you want to remove <%=fOrderList.get(i).getFoodName() %>?')" >
                              ...
                              <td>
                                  <div class="product_count">
                                      <input type="number" name="qty<%=i%>" id="sst<%=i %>" required="required" min="1" maxlength="12" value="<%=fOrderList.get(i).getFoodquantity()%>" title="Quantity:"
                              ...
                              <td>
                                  <div class="shipping_box">
                                      ...
                                      <h6>Order Date <i class="fa fa-caret-down" aria-hidden="true"></i></h6>
                                      <input style="font-size: 16px; font-family: 'Material-Design-Iconic-Font'; " type="date" value="" id="date" name="date"  />
                                      
                                      <h6>Order Time <i class="fa fa-caret-down" aria-hidden="true"></i></h6>
                                      <select class="shipping_select" name="selectedTime">
                          ...
                          <tr class="out_button_area">
                              ...
                              <td>
                                  <div class="checkout_btn_inner d-flex align-items-center">
                                       ...
                                       <input type="submit" value="Proceed Checkout" class="button" style=" width: 220px; height: 50px" id="datePicker" name="button" />
                                  </div>
                              </td>
                          </tr>
