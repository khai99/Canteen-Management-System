<%-- 
    Document   : login
    Created on : Mar 27, 2019, 1:08:59 AM
    Author     : User
--%>
				...
				<div class="col-lg-6">
					<div class="login_box_img">
						<div class="hover">
							...
							<p>Quickly register a new account now to pre-order or ordering food from our canteen.  </p>
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>Log in to enter</h3>
                                                <form class="row login_form" action="../VerifyUser" id="contactForm" method="POST" >
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="custID" placeholder="Student/Staff ID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'" required="required">
							</div>
							<div class="col-md-12 form-group">
                                                            <input type="password" class="form-control" id="name"  name="custPassword" placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'" required="required">
							</div>
							<div class="col-md-12 form-group">
