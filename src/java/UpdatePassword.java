...
public class UpdatePassword extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       Boolean success = false;
            ...
            if(!oldPass.equals(cust.getCustpassword())){
                             try (PrintWriter out = response.getWriter()) {
            out.println("<script>");
            out.println("alert('Password enter is incorrect!!');");
            out.println("location='main/profilenew.jsp';");
            out.println("</script>");
             }
            }
            if(oldPass.equals(cust.getCustpassword())){
...
//            else{
            if(oldPass.equals(cust.getCustpassword()) && newPass.equals(confirmPass)){
            cust.setCustpassword(confirmPass);
            }
            //}
                    try {
            //add record into DB
